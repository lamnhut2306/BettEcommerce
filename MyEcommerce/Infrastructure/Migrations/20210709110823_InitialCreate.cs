        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 7, 9, 18, 8, 22, 208, DateTimeKind.Local).AddTicks(2493)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 7, 9, 18, 8, 22, 217, DateTimeKind.Local).AddTicks(1073)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 7, 9, 18, 8, 22, 245, DateTimeKind.Local).AddTicks(7319)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("83052e6d-d3d7-476b-b72c-ea7d62d49cb0"), "Khách hàng tạo mới đơn hàng.", "Tạo mới" },
                    { new Guid("41e365c7-d345-442a-bba0-178275e51e3b"), "Đơn hàng được xác nhận.", "Xác nhận" },
                    { new Guid("c70e96e5-a0e3-460e-9ab9-a5ede535458d"), "Đơn hàng đã chuyển giao cho đơn vị vận chuyển.", "Đang vận chuyển" },
                    { new Guid("c3c468e2-b7f4-41e6-bf90-c619a4b52d18"), "Khách hàng đã nhận và thanh toán đơn hàng.", "Thành công" },
                    { new Guid("00efad75-a523-4832-a180-da792b980430"), "Đơn hàng bị hủy.", "Hủy" }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Products_Images_FirstImageId",
                table: "Products",
                column: "FirstImageId",
